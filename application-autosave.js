...
function updateAirtable(airtableFieldName, airtableFieldValue) {
    ...
    var requestOptions = {
        ...
        redirect: "follow",
        body: JSON.stringify([{
            "id": "{{wf {&quot;path&quot;:&quot;airtable-record&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}", "fields": {
...
function updateWebflow(webflowFieldName, webflowFieldValue) {
    ...
    return fetch("https://v1.nocodeapi.com/calmfund/webflow/MMyYDBnQutlUhsQz?itemId={{wf {&quot;path&quot;:&quot;slug&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}?live=true", requestOptions)
    .then(response => response.json())
